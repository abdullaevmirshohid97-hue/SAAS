...
type ActionsOf<M extends PermissionModule> = (typeof PERMISSION_MODULES)[M][number];
...
export const ROLE_DEFAULT_PERMISSIONS: Record<string, PermissionKey[]> = {
  ...
  doctor: [
    ...
    'queue.skip',
    'doctor_view.view',
    'doctor_view.create_soap',
    'doctor_view.edit_soap',
    'doctor_view.sign_note',
    'prescriptions.view',
