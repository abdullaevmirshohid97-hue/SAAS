...
export function DatabaseInsightsPage() {
  ...
  return (
    <div className="space-y-6">
      {/* Hero */}
      <div className="via-background relative overflow-hidden rounded-2xl border bg-gradient-to-br from-slate-50 to-indigo-50 p-6 dark:from-slate-950/40 dark:to-indigo-950/30">
      ...
      <div className="grid grid-cols-2 gap-3 sm:grid-cols-4">
        ...
        <StatCard
          ...
          value={
            isLoading ? '…' : indexRatio !== null ? `${(indexRatio * 100).toFixed(1)}%` : 'N/A'
          }
          icon={<TrendingUp className="h-4 w-4" />}
          tone={
            indexRatio !== null && indexRatio > 0.9
              ? 'success'
              : indexRatio !== null && indexRatio > 0.7
                ? 'warning'
                : undefined
          }
        />
            ...
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground mt-2 text-xs">
                  {cacheRatio > 0.95
                    ? "✅ Ajoyib — deyarli hamma so'rov keshdan"
                    : cacheRatio > 0.8
                      ? "⚠️ O'rtacha — shared_buffers oshirilishi mumkin"
                      : '❌ Past — kesh sozlamasi kerak'}
                </p>
              </CardContent>
            </Card>
          )}
          {indexRatio !== null && (
            <Card>
              ...
              <CardContent>
                ...
                <p className="text-muted-foreground mt-2 text-xs">
                  {indexRatio > 0.9
                    ? '✅ Index yaxshi ishlatilmoqda'
                    : "⚠️ Ba'zi jadvallar index yo'q"}
                </p>
              </CardContent>
            </Card>
          )}
