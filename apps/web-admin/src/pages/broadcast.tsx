            ...
            <div className="flex flex-col items-center gap-4 py-6 text-center">
              ...
              <div>
                <p className="text-lg font-semibold text-emerald-700">
                  Xabar muvaffaqiyatli navbatga qo'yildi
                </p>
                <p className="text-muted-foreground mt-1 text-sm">
                  {result.target_count} ta klinika · kanal: {result.channel}
                </p>
                <p className="text-muted-foreground mt-1 text-xs">ID: {result.broadcast_id}</p>
              </div>
              <Button
                variant="outline"
                onClick={() => {
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="text-muted-foreground text-sm">
          Klinikalarga e'lon yoki bildirishnoma yuborish
        </p>
      </div>
      ...
      <div className="grid gap-6 lg:grid-cols-3">
        <div className="space-y-4 lg:col-span-2">
          <Card>
            <CardHeader>
              <CardTitle className="text-sm">Maqsad auditoriya</CardTitle>
            </CardHeader>
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm">Xabar matni</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <div>
                <label className="text-muted-foreground mb-1 block text-xs">Mavzu *</label>
                <Input
              ...
              <div>
                <label className="text-muted-foreground mb-1 block text-xs">Xabar matni *</label>
                <textarea
                  value={body}
                  ...
                  className="bg-background focus:ring-primary w-full resize-none rounded-xl border px-3 py-2 text-sm outline-none focus:ring-2"
                />
                <p className="text-muted-foreground mt-1 text-right text-xs">{body.length} belgi</p>
              </div>
            </CardContent>
          </Card>
        </div>
        ...
        <div className="space-y-4">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-sm">Yuborish</CardTitle>
            </CardHeader>
            <CardContent className="space-y-3">
              <div className="bg-muted/30 space-y-1.5 rounded-xl p-3 text-xs">
                ...
                <div className="flex justify-between">
                  ...
                  <span className="max-w-[120px] truncate font-medium">{subject || '—'}</span>
                </div>
              </div>
