# Clary — Birinchi mijoz qidirish strategiyasi

**Solo founder uchun realistic plan**
**Maqsad:** Birinchi 5 to'lovchi mijozni 30 kun ichida topish
...
- Google Ads
- "Hammaga sotmoqchiman"

**Sababi:** Solo founder uchun reklama → ko'p lead → tushuncha berolmaslik → konversiya 1% dan past. Pul yo'qoladi.

### ✅ TO'G'RI yondashuv — Founder-led sales

**"Sizni allaqachon biladigan, sizga ishonadigan, kichik klinika"**
...
## 30 kunlik mijoz qidirish plani
...
- Instagram'da kuzatadigan klinikalar
- Yaqindagi klinikalar (ko'p marta kirib chiqgan)

**Maqsad:** 50 ta ism ro'yxat. Ehtimollik darajasi 5%.
...
15 dan **7-10 ta javob** kutiladi.

---

### Hafta 2 — Demo qo'ng'iroqlari (Kun 8-14)

#### Kun 8-10: Demo taklif
...
- Har kun 1-2 ta qo'ng'iroq (Telegram audio yoki yuzma-yuz)
- **SALES-PITCH.md** skriptini ishlatib
- Har biridan keyin 1 soatlik tahlil:
  - Nima yaxshi o'tdi?
  - Nimani noto'g'ri tushundi?
  - Mijoz nimani so'radi?

**Maqsad:** 5-7 ta demo qo'ng'iroq. 2-3 tasi "qiziqaman".

---

### Hafta 3 — Birinchi onboarding (Kun 15-21)

#### Birinchi mijoz tanlash
...
- Klinika hajmi mos (5-15 xodim)
- Toshkentda joylashgan (yuzma-yuz support)

#### Birinchi onboarding sessiya

**2 soatlik yuzma-yuz** (afzalroq) yoki **video call** (zo'rga):

1. **0:00–0:15 — Tanishuv**
   - Klinika ish jarayonini so'rab oling
   - Hozir nima qiynaydi? (3 ta asosiy muammo)

2. **0:15–0:45 — Account ochish**
   - clary.uz/signup
   - Onboarding wizard birga
   - 5 ta xodim qo'shish

3. **0:45–1:15 — Katalog**
   - 10 ta asosiy xizmat (sizning klinikangiz narxlari bilan)
   - Dorilar (apteka bor bo'lsa) — Excel import
   - Xonalar (statsionar bor bo'lsa)

4. **1:15–1:45 — Birinchi 3 bemor real ish**
   - Real bemor (yoki test bemor) bilan reception flow
   - Shifokor qabul → retsept
   - Cashier kunlik hisob

5. **1:45–2:00 — Maslahatlar**
   - Texnik support: Telegram @clary_support
   - WhatsApp: +998 XX
   - Bug topsangiz — 24 soat ichida fix
...
### Hafta 4 — Yana 2-4 mijoz (Kun 22-30)

#### Birinchi mijozdan **testimonial olish**
...
## Narx siyosati — birinchi mijozlar
...
**Sababi:** Solo founder uchun kod va sotuv parallel qiyin. Birinchi 30 kun — **80% sotuv**, 20% kod.

---

## Kun 1 — boshlash uchun aniq qadamlar

- [ ] Telegram'da ochiq qiling **@clary_support** kanali
- [ ] WhatsApp Business profili
- [ ] Email signature'da: `app.clary.uz/demo` link
- [ ] **50 ta ism ro'yxat qiling** (bugun)
- [ ] **Top 15** tanlang (bugun)
- [ ] **Loom video yozing** (5 daqiqalik, DEMO-VIDEO-SCRIPT.md bo'yicha)
- [ ] Birinchi 3 ta Telegram xabarni yuboring (bugun)

**Ertaga:** Birinchi javoblar.

**1 hafta'da:** Birinchi demo qo'ng'iroq.

**2 hafta'da:** Birinchi onboarding.

**4 hafta'da:** Birinchi to'lovchi.
...
Bu **TAM/SAM** hisoblari. **Birinchi mijoz — sizning birinchi qadam**.
